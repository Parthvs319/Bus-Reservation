...
import com.example.reservation.model.AuthResponseModel;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponseModel> login(@RequestBody AppUsers user){
        ...
        authResponseModel=new AuthResponseModel(HttpStatus.OK.value(),"Successfully Logged In.",token,System.currentTimeMillis(),expiration);
